...
export default function Navbar() {
  ...
  <div id="glow">
    ...
    const LightModeCom=()=>(
<>
        <section id='navbar' className='z-20  fixed  gap-[2.5rem] flex flex-row-reverse mt-[0px]  min-w-[100%] min-h-[11rem] bg-white items-center'>
    ...
    const DarkModeCom =()=>(
      <>
        <section id='navbar' className='z-50  fixed  gap-[2.5rem] flex flex-row-reverse mt-[0px]  min-w-[100%] min-h-[11rem] bg-black items-center'>
